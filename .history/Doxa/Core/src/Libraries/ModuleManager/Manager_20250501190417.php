    ...
    protected function getRelation()
    {
        ...
        if(!empty($this->relations)){
            foreach($this->relations as $relation){
                ...
                $relationHandler = RelationAdapter::getHandler($relation, $this->package, $this->request_config);
