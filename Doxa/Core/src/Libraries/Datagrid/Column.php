...
use Doxa\Core\Libraries\Datagrid\Enums\FormInputTypeEnum;
use Doxa\Core\Libraries\Datagrid\Enums\RangeOptionEnum;
...
class Column
{
    ...
    public function init(): void
    {
        ...
        switch ($this->type) {
            ...
            case ColumnTypeEnum::RELATED->value:
                $this->setFormOptions($this->options);
    ...
    {
        $this->databaseColumnName = $databaseColumnName ?: ($this->dbField ?? $this->index);
    }
