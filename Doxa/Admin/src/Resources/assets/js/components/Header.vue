<template>
    <header
        class="sticky top-0 before:absolute before:inset-0 before:backdrop-blur-md max-lg:before:bg-white/90 dark:max-lg:before:bg-gray-800/90 before:-z-10 before:content-[''] before:pointer-events-none z-30"
        :class="[
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16"
                ...
                <div class="flex items-center space-x-3">
                    <!-- <div>
                        <button
                            class="flex items-center justify-center w-8 h-8 ml-3 rounded-full hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800"
                            :class="{ 'bg-gray-200 dark:bg-gray-800': searchModalOpen }"
                            @click.stop="searchModalOpen = true" aria-controls="search-modal">
